    ...
    return(
        <section className={style.product}>
            <div className={style.container1}>
                <h1 className={style.title}>The most advanced technology <br/><span className={style.span}>always work hand-in-hand with qualified people</span></h1>
            </div>
            <div className= {style.container2}>
                ...
                <img className={style.ppana} src={ppana} alt = "" className={style.monitor}/>
            </div>
            <Footer />
        </section>
    )
